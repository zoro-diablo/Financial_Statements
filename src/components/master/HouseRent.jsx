  ...
  return (
    <div className='bg-yellow-200 border-t-2 border-red-800'>
      <div className='flex py-4 space-x-8 ml-14 items-center justify-center'>
        ...
        <input className='w-20 border-2 font-bold text-blue-700 border-red-600' type='number' placeholder='9100'/>
      ...
      <div className='flex py-4 space-x-14 mr-44 items-center justify-center'>
        ...
        <span className='font-bold text-lg text-blue-700'>₹</span>
        <input className='w-20 border-2 font-bold text-blue-700 border-red-600' type='number' placeholder='2500'/>
      </div>
      <div className='flex py-4 space-x-10 ml-4 items-center justify-center'>
        <h1 className='font-bold text-lg'>Interest on Housing Loan<br/>u/s 24(b)</h1>
        <span className='font-bold text-lg text-blue-700'>₹</span>
        <input className='w-20 border-2 font-bold text-blue-700 border-red-600' type='number' placeholder='0'/>
      ...
      <div className='flex py-4 space-x-8 ml-8 items-center justify-center'>
        <h1 className='font-bold text-lg'>Repayment of Housing Loan<br/>(Principle)</h1>
        <span className='font-bold text-lg text-blue-700'>₹</span>
        <input className='w-20 border-2 font-bold text-blue-700 border-red-600' type='number' placeholder='0'/>
        <p className='font-bold text-lg text-red-800'>No Limits but bound<br/> to the limit u/s 80 C</p>
      </div>
